== forge-istio-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The forge-istio-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.forge.istio.addon</groupId>
   <artifactId>forge-istio-addon</artifactId>
